...
class CategoriesViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun render(taskCategory: TaskCategory, onItemSelectd: (Int) -> Unit) {

        val color = if (taskCategory.isSelectd) {
        ...
        itemView.setOnClickListener { onItemSelectd(layoutPosition) }
